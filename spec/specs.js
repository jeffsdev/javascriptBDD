describe("song", function() {
  ...
  it("will return a standard verse of the song, if the number of bottles equals 3 to 99.", function() {
    expect(song(99)).to.equal("99 bottles of beer on the wall, 99 bottles of beer. Take one down and pass it around, 98 bottles of beer on the wall.");
  });
});
